...
use App\Exceptions\YoufeelmException;
...
class RegisterController extends Controller
{
    ...
    */
     ...
     * @apiGroup Users
     * @apiPermission Guest
     * @apiParam {RegistrationFormRequest}
     * @apiSuccess {'error': false, 'code': 200}
     * @apiError {'error': true, 'code': 500}
     */
    public function registration(RegistrationFormRequest $request)
    {
        try{
            $response = User::registration($request);
            return array('error' => false, 'code' => $response['code'] ,
                'message' => $response['message']);
        }catch (YoufeelmException $e){
